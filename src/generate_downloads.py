...
def generate_downloads():
    ...
    # ./ occupation / State.vue: < GetData: url = "dataPath('metadata/label_dod_occ_code.json')" >
    # ./ occupation / State.vue: < GetData: url = "dataPath('metadata/label_fipsnum.json')" >
    # ./ occupation / State.vue: < GetData: url = "dataPath('metadata/label_4year_cohorts.json')" >
    ...
    # ./ time / State.vue: < GetData: url = "dataPath('metadata/label_fipsnum.json')" >
    # ./ time / State.vue: < GetData: url = "dataPath('metadata/label_2year_cohorts.json')" >
